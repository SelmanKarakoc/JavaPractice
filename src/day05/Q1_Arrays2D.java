...
public class Q1_Arrays2D {
    public static void main(String[] args) {
        ...
        int [][] sayilar = {{10,20,30},{1,2,3},{100,200,300,400}};

        System.out.println(Arrays.toString(sayilar));//[[I@7c30a502, [I@49e4cb85, [I@2133c8f8]
        System.out.println(Arrays.deepToString(sayilar));//[[10, 20, 30], [1, 2, 3], [100, 200, 300, 400]]

        System.out.println(sayilar[2][1]);  //200
        System.out.println(sayilar[0][0]);  // 10
        System.out.println(sayilar[1][2]);  // 3
        System.out.println(sayilar[2][3]);  //400
        //System.out.println(sayilar[2][4]);  //ArrayIndexOutOfBoundsException
